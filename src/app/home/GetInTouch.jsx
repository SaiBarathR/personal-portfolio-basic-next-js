...
function GeitInTouchContent({ open }) {
    ...
    function ImageRenderer({ src, link, name, className }) {
        return <div className={"flex hover:bg-slate-200  md:m-0 m-2 flex-col md:flex-row gap-5  items-center cursor-pointer hover:scale-105 transition ease-in-out delay-75 hover:-translate-y-1 shadow-md p-2 rounded-lg " + className}
    ...
    return <div className={`w-full flex flex-col shadow-2xl p-4 md:p-6  gap-5 items-start rounded-2xl mb-5 overflow-y-auto ${open ? "animate-appear" : "animate-disappear"}`}>
