    ...
    return (
        <div className="w-full bg-black flex items-center justify-center">
            <div className="p-12  max-w-[1440px] text-center md:text-left  flex flex-col md:flex-row w-full gap-10 items-center ">
                ...
                <p className={"text-[#9BC1BC] " + space_grotesk.className}>Not only do I tinker with code, I also enjoy music, software development, and even a bit of wild origami!</p>
            </div>
        </div>
    )
}