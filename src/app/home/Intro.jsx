...
export default function Intro() {
    ...
    return (
        <>
            <div className='w-full min-h-[800px] dark:bg-black flex flex-col justify-center  items-center p-12 intro-background-color content-center '>
